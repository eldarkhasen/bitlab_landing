            ...
            <div class="container section-think">
               <div class="section-think__text">
                  <p class="section-think__text_p">
                     ...
                     многим сложно привыкать к новому виду обучения.
                  </p>
                  <p class="section-think__text_p">
                     Поэтому мы предлагаем ускоренные курсы программирования, пройдя который, вы сможете получить
            ...
            <div class="section container">
               ...
               <div class="section-howto__subtitles">
                  <p data-screen="lecture">
                     Живые лекции с лектором в онлайне
                  </p>
                  <p data-screen="practice">
                     Отдельный блок для практики, чтобы закрепить полученную информацию
                  </p>
                  <p data-screen="support">
                     Ментор проконсультирует вас и даст совет, как изменить что-то, исходя из вашей ситуации
                  </p>
               </div>
